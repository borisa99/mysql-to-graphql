...
const insertProfiles = `mutation ($objects: [profiles_insert_input!]! = {}) {
  ...
  `;
const insertProjectUser = `mutation ($objects: [project_user_insert_input!]! = {}) {
    insert_project_user(objects: $objects) {
      affected_rows
    }
  } 
  `;
const insertRates = `mutation ($objects: [rates_insert_input!]! = {}) {
    insert_rates(objects: $objects) {
      affected_rows
    }
  } 
  `;
